...
export const SpaceDiv : React.FC<SpaceDivTypes> = ({className, data, ...props}) => {
    ...
    return (
        <div className={cn("", className)} {...props}>
            {
                data.length === 0 ? <Card className="w-full h-full py-10 items-center flex flex-col space-y-5 justify-center hover:border-dotted hover:border-2 bg-[hsl(var(--pure-white))]/5 transition-colors duration-200 ease-linear cursor-pointer group hover:border-[hsl(var(--primary))]">
