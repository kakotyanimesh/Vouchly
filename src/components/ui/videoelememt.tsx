...
//             </video>
//             <button onClick={videoHandle} className="absolute top-1/2 -translate-y-5 left-1/2 -translate-x-1/2 bg-[hsl(var(--tertiary))]/70 text-[hsl(var(--primary))] rounded-full size-10 items-center justify-center flex cursor-pointer">
