                ...
                >
                        ...
                        <form action={handleSpaceSubmit}>
                            ...
                            <div className="flex items-center md:mt-10 mt-7 md:gap-5 gap-2 justify-end">
                                <Button disabled={isPending} variant={"transparent"} className="flex items-center gap-2 justify-center border-[hsl(var(--primary))] text-[hsl(var(--primary))]" sizes={"md"}><Plus size={16}/>Create Space</Button>
