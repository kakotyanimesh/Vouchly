...
export const FeatureCard : React.FC<FeatureCardProps> = ({className, icon, title, desc, ...props}) => {
    ...
    return (
        <motion.div 
            ...
            className={cn("rounded-md group space-y-2 h-full bg-[hsl(var(--pure-white))]/7 py-4 px-3 text-left hover:shadow-[inset_0px_0px_2px_0px_#48bb78] transition-all duration-200 ease-linear", className)} {...props}>
            <div
