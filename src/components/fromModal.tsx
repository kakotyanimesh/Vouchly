...
export const FormCreation = ({sName, sId, data} : FormDivtypes) => {
    ...
    return (
        <div className="space-y-5">
            ...
            {
                data.length === 0 ?
                <Card className="w-full h-full py-10 items-center bg-[hsl(var(--pure-white))]/5 border border-[hsl(var(--primary))]/20 backdrop-blur-3xl  flex flex-col space-y-5 justify-center  transition-colors ease-linear duration-200 group">
