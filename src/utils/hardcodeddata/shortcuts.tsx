...
export const shortCutArrayDashboard = [
	{
		...
		parentColor:
			"hover:shadow-[0px_0px_5px_0px_#48bb78] bg-[hsl(var(--primary))]/15",
	...
	},
	{
		...
		parentColor:
			"hover:shadow-[0px_0px_5px_0px_#4299e1] bg-blue-600/15 text-blue-300",
	...
	},
	{
		...
		parentColor:
			"hover:shadow-[0px_0px_5px_0px_#9f7aea] bg-purple-600/15 text-purple-300",
	...
	},
	{
		...
		parentColor:
			"hover:shadow-[0px_0px_5px_0px_#f6ad55] bg-orange-600/20 text-orange-300 backdrop-blur-3xl",
...
export const TextReviews: TextReviewProps[] = [
	{
		...
		customerCompany: "Vouchly.kakoty.me",
		stars: 4,
		imageSrc:
	...
	},
	{
		textreviewid: 2,
		textReview:
			"Vouchly revolutionized the way we showcase customer feedback. After integrating the Vouchly Wall on our landing page, our conversion rate jumped by 30%. Absolutely game-changing!",
		customerName: "Animesh",
		customerCompany: "Vouchly.kakoty.me",
		stars: 4,
		imageSrc:
	...
	},
	{
		textreviewid: 3,
		textReview:
			"Switching to Vouchly simplified our testimonial process completely. With the Vouchly Wall on our site, we saw a 30% boost in conversion rates. Highly recommend it!",
		customerName: "Animesh",
		customerCompany: "Vouchly.kakoty.me",
		stars: 4,
		imageSrc:
